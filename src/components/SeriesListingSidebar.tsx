...
export function SeriesListingSidebar({
  locale,
  formAction,
  yearMin,
  yearMax,
  ...
  const sortOpts = seriesSortSelectOptions(tb);
      ...
      <div className="rounded-lg border border-[var(--cv-border)] bg-[var(--cv-card)] p-4 shadow-sm">
        ...
        <form method="get" action={formAction} className="mt-4 space-y-0">
          ...
          <FieldSection title={L.sectionSearch} hint={L.sectionSearchHint}>
            <div>
              <label className="sr-only" htmlFor="series-sidebar-q">
                {L.seriesTitle}
              </label>
              <input
                id="series-sidebar-q"
          ...
          <FieldSection title={L.sectionSort} hint={L.sectionSortHint}>
            <div>
              <label className="sr-only" htmlFor="series-sidebar-sort">
                {L.quickSort}
              </label>
              <select
                id="series-sidebar-sort"
                name="sort"
            ...
            <div className="space-y-3">
              <div>
                <label
                  ...
                  htmlFor="series-sidebar-genre"
                >
                  {L.genres}
                </label>
                <select
                  id="series-sidebar-genre"
                  name="genre"
              ...
              <div>
                <label
                  className="mb-1 block text-xs font-medium text-[var(--cv-body)]"
                  htmlFor="series-sidebar-rating"
                >
                  {L.ratingRange}
                </label>
                <select
                  id="series-sidebar-rating"
                  name="minRating"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label
                    className="mb-1 block text-xs font-medium text-[var(--cv-body)]"
                    htmlFor="series-sidebar-from-y"
                  >
                    {L.fromYear}
                  </label>
                  <select
                    id="series-sidebar-from-y"
                    name="fromYear"
                ...
                <div>
                  <label
                    className="mb-1 block text-xs font-medium text-[var(--cv-body)]"
                    htmlFor="series-sidebar-to-y"
                  >
                    {L.toYear}
                  </label>
                  <select
                    id="series-sidebar-to-y"
                    name="toYear"
          ...
          <FieldSection title={L.sectionCredits} hint={L.sectionCreditsHint}>
            <div className="space-y-3">
              <div>
                <label
                  className="mb-1 block text-xs font-medium text-[var(--cv-body)]"
                  htmlFor="series-sidebar-dir"
                >
                  {L.director}
                </label>
                <input
                  id="series-sidebar-dir"
                  name="director"
                  type="search"
              ...
              <div>
                <label
                  className="mb-1 block text-xs font-medium text-[var(--cv-body)]"
                  htmlFor="series-sidebar-stars"
                >
                  {L.cast}
                </label>
                <input
                  id="series-sidebar-stars"
                  name="stars"
                  type="search"
